...
# moment is interpreter exit. `ignore_errors` keeps a cleanup failure from turning
# a green run red -- the sink is disposable by construction.
atexit.register(shutil.rmtree, MY_LOGS, ignore_errors=True)
